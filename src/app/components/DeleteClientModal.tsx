...
export default function DeleteClientModal({ client, isOpen, onClose, onSuccess }: DeleteClientModalProps) {
        ...
        <div className="flex min-h-full items-center justify-center p-4">
          ...
          >
            <div className="flex justify-between items-center mb-4">
              <p className="text-lg font-medium text-slate-700">Delete Client</p>
              <button
                onClick={onClose}
            ...
            <div className="mb-6">
              <div className="mb-4 p-4 bg-red-50 rounded-lg border border-red-100">
                ...
                <p className="text-center font-medium text-red-700">Are you sure you want to delete this client?</p>
              </div>
              
              {client && (
                <div className="p-4 bg-slate-50 rounded-lg">
                  <h3 className="font-medium text-slate-700 mb-1">{client.name}</h3>
